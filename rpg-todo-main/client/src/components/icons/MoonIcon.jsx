export default function MoonIcon({ className = "w-5 h-5", color = "currentColor" }) {
  return (
    <svg height="24" width="24" xmlns="http://www.w3.org/2000/svg" fill={color} viewBox="0 0 24 24" className={className}>
